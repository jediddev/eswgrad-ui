    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
            <div className="w-full max-w-xl bg-white rounded-lg shadow-md p-8">
                <h1 className="text-2xl font-bold text-center">Attendee Registration</h1>
                <p className="text-sm text-center mt-1 text-gray-500">Fill out the form below to register for grad.</p>

                <Alert className="mt-6 mb-4 bg-amber-100 border-amber-400 text-amber-700">
